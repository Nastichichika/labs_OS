...
public class Kernel extends Thread
{
  ...
  private ArrayList<Page> memVector = new ArrayList<Page>();
  ...
  public void init( String commands , String config )  
  {
...

        {
          ...
          { 
            ...
            { 
              ...
              Page page = (Page) memVector.get(id);
          ...
          { 
            ...
            for (i = 0; i <= virtPageNum; i++) 
            {
              Page page = (Page) memVector.get(i);
    ...
    for (i = 0; i < virtPageNum; i++) 
    {
      ...
      {
        Page tmp_page = (Page) memVector.get(j);
  ...
  {
    Page page = ( Page ) memVector.get( pageNum );
  ...
  public void step()
  {
    ...
    {
      Page page = ( Page ) memVector.get( Virtual2Physical.pageNum( instruct.addr , virtPageNum , block ) );
      if ( page.physical == -1 ) 
      {
        if ( doFileLog )
        {
